...
$añoingreso=date("Y");
$sql = "UPDATE `persona` SET `id`=\"$id\",`nombre`=\"$nombre\",`apellido`=\"$apellido\",`dui`=\"$dui\",`nit`=\"$nit\",`afp`=\"$afp\",`pasaporte`=\"$pasaporte\",`direccion`=\"$direccion\",`isss`=\"$isss\",`sexo`=\"$sexo\",`departamento`=\"$departamento\",`fecha`=\"$fecha\",`estadofamiliar`=\"$estadofamiliar\",`fechaingreso`=$añoingreso WHERE `id`=\"$idantiguo\"";
