...
$sql = "INSERT INTO `calificacioncurriculum`(`id`, `estudios`, `experiencia`, `referencia`, `personalidad`, `inteligencia`, `condicion`, `nota`, `escrita`) VALUES (\"$id\",$estudios,$experiencia,$referencias,$personalidad,$inteligencia,\"$condicion\",$nota,$escrita)";
