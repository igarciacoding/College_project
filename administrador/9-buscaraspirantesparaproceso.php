...
<div id="conten"> 
 ...
 <tr><td colspan="5" align="center" valign="middle" class="BordeSuperior"><h3>Buscar aspirantes para proceso de seleccion</h3></td>
  </tr> <tr><td align="center" valign="middle" nowrap="nowrap"><h4>&nbsp;</h4></td>
  ...
  <td align="center" valign="middle" nowrap="nowrap"><select name="CampoDepartamento" id="CampoDepartamento" title="Seleccione el departamento para realizar la busqueda">
    ...
    <td width="151" align="center" valign="middle" nowrap="nowrap"><input type="text" name="universidadoinstitucion" id="universidadoinstitucion" placeholder=" Universidad o  Institucion" title="Ingrese la institucion o la universidad para realizar la busqueda"></td></tr><tr><td align="center" valign="middle" nowrap="nowrap">&nbsp;</td>
    </tr><tr><td align="center" valign="middle" nowrap="nowrap"><input name="button" type="button" class="Botones" id="button" value="Buscar persona" title="Click aqui para realizar la busqueda de aspirantes segun lo escrito en los campos de busqueda"></td>
  </tr><tr><td align="center" valign="middle" nowrap="nowrap">&nbsp;</td>
  </tr><tr><td align="center" valign="middle" nowrap="nowrap"><h4>Numero de personas</h4></td>
    </tr><tr><td align="center" valign="bottom" nowrap="nowrap"><h4>
    ...
    <td colspan="4" align="center" valign="middle"><input name="button2" type="button" class="Botones" id="PDF" value="Ver PDF" title="Click para ver el curriculum del aspirante seleccionado">      <input name="Eliminar" type="button" class="Botones" id="Eliminar" value="Eliminar Curriculum" title="Click aqui para eliminar un aspirante"></td></tr>
</table>
    <p>&nbsp;</p>
    <p>
