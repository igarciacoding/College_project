...
<input name="idantiguo" id="idantiguo" type="hidden" value="<?php echo $id; ?>">
    <div id="contenedor">  
  ...
  <tr>
    ...
    <td width="128" nowrap><input name="CampoNombre" type="text" id="CampoNombre" title="Ingrese el nombre"  placeholder="Ingrese el nombre" value="<?php echo $nombres; ?>"></td>
    <td width="72"><strong>Apellidos:
        
    </strong></td>
    <td width="123"><strong>
      <input name="CampoApellido" type="text" id="CampoApellido" placeholder="Ingrese el apellido" title="Ingrese el apellido" value="<?php echo $apellidos; ?>">
    </strong></td>
    <td width="35"><strong>DUI:</strong></td>
    <td width="74"><strong>
      <input name="CampoDui" type="text" id="CampoDui" size="10" maxlength="10" title="Ingrese el numero de dui" placeholder="00000000-0" value="<?php echo $dui; ?>">
    </strong></td>
    <td width="34"><strong>NIT:</strong></td>
    <td width="112"><strong>
      <input name="CampoNit" type="text" id="CampoNit" size="14" maxlength="17" title="Ingrese el numero de nit" placeholder="0000-000000-000-0" value="<?php echo $nit; ?>">
    </strong></td>
    <td width="44" align="center"><strong>AFP:</strong></td>
    <td width="86"><strong>
      <input name="CampoAfp" type="text" id="CampoAfp" size="12" maxlength="12" title="Ingrese el numero de afp" placeholder="000000000000" value="<?php echo $afp; ?>">
    </strong></td>
    <td width="70"><strong>Pasaporte:</strong></td>
    <td width="74"><strong>
      <input name="CampoPasaporte" type="text" id="CampoPasaporte" size="4" maxlength="10" title="Ingrese el numero de pasaporte" placeholder="X0000000" value="<?php echo $pasaporte; ?>">
    </strong></td>
    </tr>
  <tr>
    <td height="22" nowrap><strong>Direccion:</strong></td>
    <td colspan="10" nowrap><input name="CampoDireccion" type="text" id="CampoDireccion" title="Se requiere que ingrese la direccion de su vivienda donde reside actualmente" autocomplete="off" size="95" placeholder="Ingrese su direccion actual" value="<?php echo $direccion; ?>">
      <strong> ISSS:</strong></td>
    <td nowrap><strong>
      <input name="CampoIsss" type="text" id="CampoIsss" size="10" maxlength="10" title="Ingrese el numero del Isss" placeholder="000000000" value="<?php echo $isss; ?>">
    </strong></td>
  </tr>
  <tr>
  ...
  <select  name="CampoEstadoFamiliar" id="CampoEstadoFamiliar" title="Se requiere que seleccione su estado familiar" >
    ...
    <td align="left" nowrap><strong>
      <input type="text" name="CampoFecha" id="CampoFecha" placeholder="00/00/0000" title="Ingrese la fecha de nacimiento: Ejemplo: 00/00/0000" value="<?php echo $fecha; ?>">
      </strong></td>
  </tr>
  <tr>
    ...
    <td colspan="5" align="center" nowrap><input name="GuardarDatos" type="button" class="Botones" id="GuardarDatos" value="Guardar datos personales" title="Click aqui para actualizar y guardar sus datos personales"></td>
  ...
  <tr>
    ...
    <?php echo $telefonos;?>
      ...
      <table width="200" border="0" align="center">
        ...
        <tr>
          <td colspan="2" align="center"><input name="terminarprocesoactualizar" type="button" class="Botones" id="terminarprocesoactualizar" value="Terminar ingreso de datos e ingresar nuevo aspirante" >
...
<footer id="PiePagina"></footer>  
	...
	<script src="../javascript/metodosdatospersonales/metodosdatospersonalesactualizar.js"  ></script>
