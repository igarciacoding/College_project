...
<div id="menu">
   ...
   <form action="" method="post" name="NuevoAspirante" id="NuevoAspirante"> 
    ...
    <td class="BordeSuperior" colspan="12" align="center" valign="middle" nowrap><h2>Datos Personales</h2></td></tr><tr>
    ...
    <td width="72"><strong>Apellidos:</strong></td>
    <td width="123"><strong>
    <input name="CampoApellido" type="text" id="CampoApellido" placeholder="Ingrese el apellido" title="Ingrese el apellido">
    </strong></td><td width="35"><strong>DUI:</strong></td><td width="74"><strong>
      <input name="CampoDui" type="text" id="CampoDui" size="10" maxlength="10" title="Ingrese el numero de dui" placeholder="00000000-0">
    </strong></td><td width="34"><strong>NIT:</strong></td><td width="112"><strong>
      <input name="CampoNit" type="text" id="CampoNit" size="14" maxlength="17" title="Ingrese el numero de nit" placeholder="0000-000000-000-0"></strong></td>
    <td width="44" align="center"><strong>AFP:</strong></td>
    <td width="86"><strong>
      <input name="CampoAfp" type="text" id="CampoAfp" size="12" maxlength="12" title="Ingrese el numero de afp" placeholder="000000000000"> </strong></td>
    <td width="70"><strong>Pasaporte:</strong></td><td width="74"><strong>
