...
<div id="conten"> 
  ...
  <tr>
    <td colspan="5" align="center" valign="middle" class="BordeSuperior"><h2>Actualizar Calificacion</h2></td>
    </tr>
  <tr>
  ...
  <tr>
    <td align="center" valign="middle" nowrap="nowrap"><input type="text" name="referencias" id="referencias" placeholder="       Referencias(5%):"></td>
    </tr>
  <tr>
    <td width="151" align="center" valign="middle" nowrap="nowrap"><h4>Evaluacion Psicologica</h4></td>
    </tr>
  <tr>
    <td align="center" valign="middle" nowrap="nowrap"><input type="text" name="personalidad" id="personalidad" placeholder="     Personalidad(10%):"></td>
    </tr>
  <tr>
  ...
  <tr>
    <td align="center" valign="middle" nowrap="nowrap"><h4>Entrevista</h4></td>
    </tr>
  <tr>
    <td align="center" valign="middle" nowrap="nowrap"><select name="CampoCondicion" id="CampoCondicion">
  ...
  <tr>
    <td align="center" valign="middle" nowrap="nowrap"><input type="text" name="nota" id="nota" placeholder="            Nota(10%):"></td>
    </tr>
  <tr>
    <td align="center" valign="bottom" nowrap="nowrap"><h4>Prueba Tecnica</h4></td>
    </tr>
  <tr>
    <td align="center" valign="bottom" nowrap="nowrap"><input type="text" name="escrita" id="escrita" placeholder="          Escrita(40%):"></td>
    </tr>
  <tr>
...
<footer id="PiePagina"></footer>  
    ...
    <script src="../javascript/metodocalificarcurriculum/actualizarcalificacion.js"           ></script> 
