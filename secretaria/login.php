...
<div id="contenedor"> 
	<div id="container">
		  <form action="../administrador/welcome.html" id="Formulario">
		    <div class="Titulos">Bienvenida Secretaria</div>
		    <div class="Titulos"><img src="../images/secretaria.png" name="imagen" width="110" height="85" id="imagen"></div>
		    <p>&nbsp;</p>
...
<footer id="PiePagina"></footer>  
    ...
    <script src="../javascript/metodoverificarpersona/verificarsecretaria.js"		></script>
