...
$pdf->Cell(190,6,'Lista de personas para proceso de seleccion','B',0,'C');
$pdf->Ln(13);
...
while($datospersonales=@mysql_fetch_array($ejecutarconsulta)){
	...
	$pdf->MultiCell(175,5,$datospersonales["direccion"]);
...
$pdf->Output("Lista de personas para proceso de seleccion.pdf","I");
?>
