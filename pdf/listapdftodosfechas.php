...
$fecha=$_POST['a'];
$pdf->Cell(190,6,'Lista de todas las personas que estan registradas en el sistema','0',0,'C');
$pdf->Ln(6);
$pdf->Cell(190,6,utf8_decode('del año ').$fecha,'B',0,'C');
$pdf->Ln(13);
...
$sql = "SELECT * FROM `persona` where fechaingreso='$fecha'";
$relleno=0;
