...
$segunplaza=utf8_decode($_POST['select2']);
$pdf = new PDF();
$pdf->AliasNbPages();
$pdf->AddPage();
...
$pdf->Cell(190,6,'Lista de todas las personas que tiene la plaza','0',0,'C');
$pdf->Ln(6);
$pdf->Cell(190,6,$segunplaza,'B',0,'C');
$pdf->Ln(13);
...
$pdf->Ln(5);
$sql = "SELECT * FROM `persona` where plaza='$segunplaza'";
$relleno=0;
