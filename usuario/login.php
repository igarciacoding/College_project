...
<div id="contenedor"> 
	<div id="container">
		  <form action="../administrador/welcome.html" id="Formulario">
		    <div class="Titulos">Bienvenido Usuario/a</div>
		    <div class="Titulos"><img src="../images/usuario.png" name="imagen" width="110" height="85" id="imagen"></div>
		    <p>&nbsp;</p>
...
<footer id="PiePagina"></footer>  
    ...
    <script src="../javascript/metodoverificarpersona/verificarusuario.js"			></script>
